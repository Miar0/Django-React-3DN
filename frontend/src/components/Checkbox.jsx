...
const Checkbox = (props) => {
    return (
        <label className="relative inline-block w-5 h-5">
            <input
                type="checkbox"
                className="peer appearance-none w-full h-full border dark:border-gray-300/80 border-gray-400 rounded-md bg-transparent transition-colors duration-300 cursor-pointer checked:bg-blue-500 checked:border-transparent"
                {...props}
            />
